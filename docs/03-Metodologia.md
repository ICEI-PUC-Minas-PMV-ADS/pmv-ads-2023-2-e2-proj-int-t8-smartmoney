...
<table style="border-collapse: collapse;">
  ...
  <tr>
    ...
    <td style="border: 1px solid black; padding: 10px;"><a href="https://github.com/ICEI-PUC-Minas-PMV-ADS/pmv-ads-2023-2-e2-proj-int-t8-smartmoney.git" target="_blank">Clique aqui</a> para acessar o repositório</td>
  </tr>
  <tr>
